...
public class AugmentedImageNode extends AnchorNode {
  ...
  private ModelRenderable dogRendable;
  ...
  private AugmentedImgActivity context;
  ...
  /**private static CompletableFuture<ModelRenderable>dog;
   ...
   .setSource(context, Uri.parse("12228_Dog_v1_L2.obj"))
   .build();
   }
   }*/
  ...
  public AugmentedImageNode(Context context) {
    ...
    this.context = (AugmentedImgActivity) context;
    if (ulCorner == null) {
      ulCorner =
  ...
  public void setImage(AugmentedImage image) {
    ...
    /**
     ...
     dogNode = new Node();
     dogNode.setParent(this);
     dogNode.setLocalPosition(localPosition);
     dogNode.setRenderable(dog.getNow(null));*/
